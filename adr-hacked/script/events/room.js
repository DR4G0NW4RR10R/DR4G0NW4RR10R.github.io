		...
		scenes: {
			...
			scales: {
				...
				onLoad: function() {
					...
					$SM.addM('stores', {'wood': 0, 'scales': numScales});
				},
				buttons: {
					'leave': {
						text: _('leave'),
			...
			teeth: {
				...
				onLoad: function() {
					...
					if(numTeeth === 0) numTeeth = 10;
					$SM.addM('stores', {'wood': 0, 'teeth': numTeeth});
				},
				buttons: {
					'leave': {
						text: _('leave'),
			...
			cloth: {
				...
				onLoad: function() {
					...
					if(numCloth === 0) numCloth = 10;
					$SM.addM('stores', {'wood': 0, 'cloth': numCloth});
				},
				buttons: {
					'leave': {
						text: _('leave'),
